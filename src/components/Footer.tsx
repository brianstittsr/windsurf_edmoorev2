      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="italic text-gray-300">&quot;Doing Nothing is an Option.&quot; – Dr. Edmund Moore</p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/speaking" className="text-gray-300 hover:text-white">
                  Speaking Engagements
                </Link>
              </li>
              <li>
                <a href="mailto:info@edmundmoore.com" className="text-gray-300 hover:text-white">
